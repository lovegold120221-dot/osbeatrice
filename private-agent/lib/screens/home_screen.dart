...
import '../services/skill_invocation_bridge.dart';
import '../services/skill_runner.dart';
import '../services/voice_service.dart';
import '../widgets/message_bubble.dart';
import '../services/telegram_service.dart';
import '../services/chat_history_service.dart';
import '../services/notification_service.dart';
import '../services/firebase_task_bridge.dart';
import 'settings_screen.dart';
import 'task_history_screen.dart';
import 'beatrice_voice_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  late final FirebaseTaskBridge _firebaseTaskBridge;
  late final SkillInvocationBridge _skillBridge;
  late final SkillRunner _skillRunner;
  ...
  void initState() {
    ...
    _firebaseTaskBridge = FirebaseTaskBridge(
    ...
    _skillBridge = SkillInvocationBridge(
      aiService: _aiService,
  ...
  void _openBeatriceVoice() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => BeatriceVoiceScreen(
          aiService: _aiService,
        ),
      ),
    );
  ...
  void dispose() {
    ...
    _firebaseTaskBridge.dispose();
    _skillBridge.dispose();
          ...
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                ...
                if (_isListening)
                  BoxShadow(
                    color: BeatriceTheme.danger.withValues(alpha: 0.35),
                    blurRadius: 12,
                    spreadRadius: 2,
                  ),
              ],
