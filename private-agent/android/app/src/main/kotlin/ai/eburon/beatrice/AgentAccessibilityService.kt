...
class AgentAccessibilityService : AccessibilityService() {
    ...
    private val ownPackageName = "ai.eburon.beatrice"
    ...
    override fun onAccessibilityEvent(event: AccessibilityEvent?) {
        ...
        if (event.packageName?.toString() == "ai.eburon.beatrice") return
    ...
    fun getCurrentPackage(): String? {
        ...
        for (window in windows) {
            ...
            // An active Beatrice OS application window is the main Flutter app.
